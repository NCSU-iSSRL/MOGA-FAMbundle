...
save('homopop_200_rect_lateral_aug16.mat')
...
load('homopop_200_rect_lateral_aug16.mat')
% for i = 1:num_individuals
...
save('homopop_200_rect_lateral_aug16_Fb_deltalm.mat','fitness')
...
plot(Vm_cm3,Fb_N,'k.')
hold on
load('homopop_200_rect_lateral_aug8_Fb_Vm.mat')
plot(fitness(:,2)*((10^2)^3),fitness(:,1),'b.')
